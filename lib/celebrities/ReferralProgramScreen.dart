...
class ReferralProgramScreen1 extends StatefulWidget {
  const ReferralProgramScreen1({Key? key}) : super(key: key);

  @override
  _ReferralProgramScreen1State createState() => _ReferralProgramScreen1State();
}

class _ReferralProgramScreen1State extends State<ReferralProgramScreen1> {
