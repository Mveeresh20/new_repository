...
// Image picker
  ...
  final String _apiUrl = "https://demo.infoskaters.com/api/brand_update_profile.php";
  File? _selectedImage;
  ...
  Future<void> fetchProfileData(String u_id) async {
    final String apiUrl = "https://demo.infoskaters.com/api/get_brand.php?u_id=$u_id";
    final String getasicDetailsApi = "https://demo.infoskaters.com/api/get_brand_basic.php?u_id=$u_id";
////
    try {
      ...
      if (response.statusCode == 200) {
        ...
        setState(() {
          ...
          _phoneController.text = data['mob'] ?? '';
